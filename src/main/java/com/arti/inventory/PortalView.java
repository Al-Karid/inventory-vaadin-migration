...
public class PortalView extends VerticalLayout {
    ...
    public PortalView() {
        ...
        externalApps.add(new PortalItemList("Gestion des Equipements", "http://169.239.64.130:8002/dashboard", VaadinIcon.RECORDS.create(), "_blank"));
        externalApps.add(new PortalItemList("Gestion des Véhicules", "https://tinyurl.com/arti-vehicules", VaadinIcon.CAR.create(), "_blank"));
        externalApps.add(new PortalItemList("Gestion des Missions", "http://169.239.64.130:8002/missions", VaadinIcon.AIRPLANE.create(), "_blank"));
        externalApps.add(new PortalItemList("Gestion des Immobilisations", "http://immobilisations.arti.ci", VaadinIcon.BUILDING.create(), "_blank"));
